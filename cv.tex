...
\smallskip
Organization of the conference ``Integrability in Gauge and String Theories 2023''.
\smallskip
{\small
\begin{itemize}
  \item developed a set of \highlight{Bash scripts} to automate the \href{https://indico.phys.ethz.ch/event/49/page/26-hybrid-setup}{\color{ETHBlue120}hybrid setup} of the conference
\end{itemize}
}
...
\smallskip
Participated in the public scientific fair with a stand on the topic of curved spaces. 
\smallskip
{\small
\begin{itemize}
  \item developed the simulator (\highlight{using C++ and openMP}) to travel through curved 3D spaces \href{https://hypray2.phys.ethz.ch/}{\color{ETHBlue120}hypray2}
\end{itemize}
}
...
\smallskip
Developer of a tool to manage articles and references for scientific writing. 
\smallskip
{\small
\begin{itemize}
  \item uses \highlight{Python}, \highlight{PySide}, \highlight{SQLite}
  \item supports API requests to arxiv.org to fetch metadata and PDFs
\end{itemize}
